...
| 🇷🇺 | 🇬🇧 |
|:---:|:---:|
| Практические работы по объектно-ориентированному программированию на C++, выполненные в колледже г. Сочи. | Practical works on object-oriented programming in C++, completed at the college in Sochi. |
